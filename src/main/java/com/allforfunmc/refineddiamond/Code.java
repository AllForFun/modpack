...
public class Code {
	...
	// Shaped Recipes
	GameRegistry.addRecipe(new ItemStack(refinedDiamond, 2), new Object[] { " H ", "H H", " H ", 'H', hotDiamond });
	GameRegistry.addRecipe(new ItemStack(refinedpick), new Object[] { "RRR", " S ", " S ", 'R', refinedDiamond, 'S', Items.stick });
	GameRegistry.addRecipe(new ItemStack(refinedaxe), new Object[] { "RR ", "RS ", " S ", 'S', Items.stick, 'R', refinedDiamond });
	GameRegistry.addRecipe(new ItemStack(MeltingPick), new Object[] { "DDD", " S ", " S ", 'D', hotDiamond, 's', Items.stick });
	/*
	 * Block
	 */
	...
	GameRegistry.addRecipe(new ItemStack(Refined_Diamond_Block), new Object[] { "RRR", "RRR", "RRR", 'R', refinedDiamond });
    }
}
