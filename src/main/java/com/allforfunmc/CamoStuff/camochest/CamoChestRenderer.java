...
public class CamoChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntityCamoChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof CamoChest && i == 0)
            {
                try
                {
                ((CamoChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityCamoChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}