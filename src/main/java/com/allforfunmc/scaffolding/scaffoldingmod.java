...
public class scaffoldingmod {
	...
	GameRegistry.addRecipe(new ItemStack(BlockOfScaffolding, 16), new Object[] { "SSS", "SPS", "SSS", 'S', Blocks.stone, 'P', Items.wooden_pickaxe });
	GameRegistry.addRecipe(new ItemStack(BlockOfScaffoldingWithLight, 8), new Object[] { "SSS", "SCS", "SSS", 'S', BlockOfScaffolding, 'C', Items.coal });
    }
}