...
public class Code {
	...
	// Shaped Recipes
	GameRegistry.addRecipe(new ItemStack(obsidianpickaxe), new Object[] { "OOO", " S ", " S ", 'O', Blocks.obsidian, 'S', Items.stick });
	GameRegistry.addRecipe(new ItemStack(obsidianaxe), new Object[] { "OO ", "OS ", " S ", 'O', Blocks.obsidian, 'S', Items.stick });
    }
