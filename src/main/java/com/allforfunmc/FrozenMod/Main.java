...
public class Main {
	...
	MassRegister.Items(new Item[] { IceSword, IceAxe, IcePick, IceCrystal }, new String[] { "ice_sword", "ice_axe", "ice_pick", "IceCrystal" }, "frozenmod");
    ...
    // Blocks
    public static Block IceOre = new TemplateBlock(Material.ice, "").setBlockName("ice_ore").setBlockTextureName("sleshymod:ice_ore").setHardness(6f);
